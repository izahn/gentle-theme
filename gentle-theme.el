...
(let ((darker "black")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((t (:foreground ,purpleish :background nil))))
   ...
   `(outline-2 ((t (:foreground ,darkish :weight bold ))))
   `(outline-3 ((t (:foreground ,grayish :weight bold))))
   ...
   `(org-block-begin-line ((t (:foreground ,grayish))))
   `(org-block-end-line ((t (:foreground ,grayish))))
